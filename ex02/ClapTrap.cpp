...
ClapTrap::ClapTrap() : _hp(100) , _ep(10) , _ad(0)
{
    std::cout << "ClapTrap created." << std::endl;
}
ClapTrap::ClapTrap(std::string const Name) : _Name(Name) , _hp(100) , _ep(10) , _ad(0)
{
    std::cout << Name << " ClapTrap created." << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &c) : _Name(c._Name) , _hp(100) , _ep(10) , _ad(0)
{
